...
Author: knull-cc
Date: 2025-02-02
Description: This script is used for loading a model and generating responses 
based on user input.It utilizes the transformers library for model handling 
and the peft library for model fine-tuning.
"""
...
def main():
    ...
    peft_model = PeftModel.from_pretrained(
        base_model,
        "/content/drive/MyDrive/knullcc/MiniCPM-4b-19k-A100",
        is_trainable=False
    )
